...
current_pos1 = (-0.3, 0.1, z_function(0.7, 0.4))
current_pos2 = (0.6, -0.7, z_function(0.7, 0.4))
...
for _ in range(1000):
  ...
  ax.scatter(current_pos1[0], current_pos1[1], current_pos1[2], color='cyan', zorder = 1)
